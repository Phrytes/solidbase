---
{"dg-publish":true,"permalink":"/product-design/potential-services/message-filters/"}
---

A huge argument against improving internet privacy or decentralizing the web, is the fact that these services can be used by criminals, especially networks of child abuse.

On one hand, I think Solid Pods would not make a huge difference, as criminals already use encrypted networks these days.

On the other hand, I think some criminal activities methods actually be decreased by solid pods in combination with third party computing. 
