---
{"dg-publish":true,"permalink":"/possible-solid-business-models/"}
---


An internet influenced by Solid Pods urges business to adapt different business models: data collection can't be the main source of income anymore. Instead you possible get focus on different sources of income:
...
#### Reflection
The combination of 2 and 4 could still lead to powerful monopolies. However, if clients keep control of their own data and adapt standardized ways to share it, the risk to vendor lock-ins should at least be decreased.